			...
			<div className="m-4 sm:m-6">
				...
				<ul className="space-y-3 text-gray-700">
					...
					<li className="flex items-center">
						...
						<a href="https://www.linkedin.com/in/mrsagarbiswas/" target="_blank" className='border-b-2 border-green-500'>
							Sagar Biswas
						</a>
				...
				<div className="mt-6">
					<Link to="https://drive.google.com/file/d/1U5AUd1l4uYWvDWKNypp4XpDej91Qzu2A/view?usp=sharing" target="_blank">View Project Report</Link>
				</div>
			</div>
		</footer>
	)
